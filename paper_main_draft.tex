...
\fcolorbox{xkcdBlue}{xkcdWhite}{
    \begin{minipage}[]{.9\linewidth}
        ...
        \textcolor{xkcdRed}{Do not edit the main tex file. To add your material, place it in one of the relevant tex files, which will then be imported using an $\mathtt{\backslash input\lbrace\rbrace}$ statement.}
    \end{minipage} 
    }

NB: maximum manuscript size \& length requirements: 5 MB \& 15 pages total.

\section{What is TudatPy?}
    Here's an example reference.~\autocite{dirkx2019a} \\
...
\section{Project setup}
    \input{structure_of_project}

\section{Code setup}
    \input{structure_of_code}
